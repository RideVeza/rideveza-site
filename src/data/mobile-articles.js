// The mobile support hub articles, in display order: get the app & get in
// (the static troubleshooting hubs under public/), then using the app
// (Astro guides in src/pages/support/mobile/).
export const articles = [
  {
    href: "/support/mobile/download-app/",
    title: "Downloading the app",
    blurb: "Get the Veza Mobile App onto your phone, and what to check before you download.",
  },
  {
    href: "/support/mobile/account-setup/",
    title: "Setting up your account",
    blurb: "Set up your account with a passkey from your invitation email.",
  },
  {
    href: "/support/mobile/signing-in/",
    title: "Signing in",
    blurb: "Sign in with one tap using your passkey.",
  },
  {
    href: "/support/mobile/run-dashboard/",
    title: "Run dashboard",
    blurb: "See today's runs, upcoming runs and your assigned routes.",
  },
  {
    href: "/support/mobile/run-summary/",
    title: "Run summary",
    blurb: "Open a run to see its schedule, riders, team and map.",
  },
  {
    href: "/support/mobile/step-by-step/",
    title: "Step by step view",
    blurb: "Complete a run — check in, inspect, and mark riders picked up or absent.",
  },
  {
    href: "/support/mobile/rider-details/",
    title: "Rider details",
    blurb: "View a rider's profile — care needs, contacts, school and schedule.",
  },
  {
    href: "/support/mobile/routes/",
    title: "Assigned routes",
    blurb: "See each route's weekly schedule, details and pay.",
  },
  {
    href: "/support/mobile/contacts/",
    title: "Contacts",
    blurb: "Find phone numbers and emails for your organization.",
  },
  {
    href: "/support/mobile/resources/",
    title: "Resources",
